			...
			<form:form modelAttribute="reserveTourForm">
				<table>
					...
					<tr>
						...
						<td>
							<form:textarea path="remarks" /> <br>
							<spring:message code="label.tr.searchtour.lessThanEightyCharsMessage" />
							<br>
							<spring:message code="label.tr.searchtour.opinionSuggestionMessage" />
						</td>
					</tr>
				</table>
				<br />
