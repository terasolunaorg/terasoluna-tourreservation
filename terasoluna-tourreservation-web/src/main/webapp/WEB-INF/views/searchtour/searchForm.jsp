  ...
  <div class="span-24 last">
    <form:form method="get" modelAttribute="searchTourForm" cssClass="inline">
      <fieldset>
        ...
        <div class="span-24 last">
          <input id="searchBtn" type="submit" name="search"
    ...
    <table id="toursTable">
      ...
      <c:forEach var="tourInfo" items="${page.content}" varStatus="sts">
        <tr>
          ...
          <td><a
            href="${pageContext.request.contextPath}/reservetour/read?tourCode=${f:h(tourInfo.tourCode)}&${f:query(searchTourForm)}&page=${f:h(page.number)}&size=${f:h(page.size)}">
