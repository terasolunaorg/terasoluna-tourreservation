...
<div class="container">
	...
	<div class="span-24 last">
		<form:form method="get" modelAttribute="searchTourForm" cssClass="inline">
			<fieldset>
				...
				<div class="span-14">
					<form:label path="depYear"><spring:message code="label.tr.common.depDate" /></form:label>
				...
				<div class="span-8 last">
					<form:label path="tourDays"><spring:message code="label.tr.common.tourDays" /></form:label>
					<form:select path="tourDays" items="${CL_TOUR_DAYS}" />
				</div>
				<spring:message code="label.tr.searchtour.placeMessage"
					var="place_label" />
				<div class="span-14">
					<form:label path="depCode"><spring:message code="label.tr.common.depPlace" /></form:label>
				...
				<div class="span-8 last">
					<form:label path="arrCode"><spring:message code="label.tr.common.arrPlace" /></form:label>
				...
				<div class="span-14">
					<form:label path="adultCount"><spring:message code="label.tr.common.persons" /></form:label>
				...
				<div class="span-8 last">
					<form:label path="basePrice"><spring:message code="label.tr.common.basePrice" /></form:label>
	...
	<c:if test="${page != null}">
		...
		<p class="notice">
			<spring:message code="label.tr.searchtour.resultCountMessage" arguments="${page.totalElements}" />
		</p>
