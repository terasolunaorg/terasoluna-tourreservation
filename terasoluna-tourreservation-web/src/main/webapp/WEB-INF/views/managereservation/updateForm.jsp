    ...
    <table>
      ...
      <tr>
        ...
        <td colspan="3"><spring:message code="label.tr.common.adult" /> <form:select
            ...
            items="${CL_CHILD_COUNT}" /> <spring:message code="label.tr.common.person" /></td>
      </tr>
    </table>
        ...
        <tr>
          ...
          <td>
            <div class="button">
              ...
              <input type="hidden" name="reserveNo" value="${f:h(reserve.reserveNo)}" /><input
                id="confirmBtn" type="submit" name="confirm" value="${changeReservationButton}" />
            </div>
          </td>
        </tr>
      </table>
