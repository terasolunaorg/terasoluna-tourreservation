...
[![Build Status for 5.2.x](https://travis-ci.org/terasolunaorg/terasoluna-tourreservation.svg?branch=5.2.x)](https://travis-ci.org/terasolunaorg/terasoluna-tourreservation)
