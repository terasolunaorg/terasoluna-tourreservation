...
public class MessageKeys {
    ...
    /** label.tr.common.passwordConfirm=Password Confirm */
    ...
    /** label.tr.common.pageUnauthorizedMessage=Need to authentication. */
    ...
    /** label.tr.common.paymentMethod=Payment Method */
    public static final String LABEL_TR_COMMON_PAYMENTMETHOD = "label.tr.common.paymentMethod";

    /** label.tr.common.paymentAccount=Bank Account for Transfer */
    ...
    /** label.tr.common.pdfdownloadMessage=PDF can be download for this information */
    public static final String LABEL_TR_COMMON_PDFDOWNLOADMESSAGE = "label.tr.common.pdfdownloadMessage";

    /** label.tr.common.downloadpdfBtnMessage=Download PDF */
    ...
    /** e.tr.fw.0001=Your Request is conflicted. */
    ...
    /** e.tr.fw.0003=Unhandle system error occured! */
    ...
    /** label.tr.menu.menuMessage=This is a menu screen. */
    public static final String LABEL_TR_MENU_MENUMESSAGE = "label.tr.menu.menuMessage";

    /**
     * label.tr.menu.tourSearchMessage=You can search tours with the specified conditions. <br>
     * \nYou can also search for tour reservations. You must be logged in to the reservation.
     */
     ...
     * \nIn order to login you must registere members in advance.
     */
    ...
    /**
     * label.tr.login.notCustmerMessage=Customers do not have a member ID, please register your membership with the buttons
     * below.
     */
    public static final String LABEL_TR_LOGIN_NOTCUSTMERMESSAGE = "label.tr.login.notCustmerMessage";

    /** label.tr.managecustomer.managecustomerMessage=Register Custmer */
    public static final String LABEL_TR_MANAGECUSTOMER_MANAGECUSTOMERMESSAGE = "label.tr.managecustomer.managecustomerMessage";

    /** label.tr.managecustomer.MembershipInfoMessage=Information */
    public static final String LABEL_TR_MANAGECUSTOMER_MEMBERSHIPINFOMESSAGE = "label.tr.managecustomer.MembershipInfoMessage";

    /**
     * label.tr.managecustomer.createFormMessage=<strong>Membership information input<\/strong> -> Confirm information ->
     * Completed<br>
     * \nPlease enter the information to be registered members.<br>
     * \nPlease press the input, \"Confirm\" button when finished.
     */
    public static final String LABEL_TR_MANAGECUSTOMER_CREATEFORMMESSAGE = "label.tr.managecustomer.createFormMessage";

    /**
     * label.tr.managecustomer.createConfirmMessage=Membership information input -> <strong>Confirm information<\/strong> ->
     * Completed<br>
     * \nPlease confirm your input. <br>
     * \nPlease press the confirmation, \"Register\" button when finished.
     */
    public static final String LABEL_TR_MANAGECUSTOMER_CREATECONFIRMMESSAGE = "label.tr.managecustomer.createConfirmMessage";

    /**
     * label.tr.managecustomer.createCompleteMessage=Membership information input -> Confirm information ->
    ...
    /** label.tr.managecustomer.zipExampleMessage=Ex. 01-234506789 */
    public static final String LABEL_TR_MANAGECUSTOMER_ZIPEXAMPLEMESSAGE = "label.tr.managecustomer.zipExampleMessage";

    /** label.tr.managecustomer.telExampleMessage=Ex. 262-0002 */
     ...
     * <p>
     * <strong>Search Tour<\/strong> -> Check the contents \u21D2 Confirm reservation -> Completed<\/p>\n
     * <p>
     ...
     * pressing the link name of the tour.<\/p>
     */
    ...
    /** label.tr.searchtour.SearchCriteriaTourMessage=Tour Search Condition */
    public static final String LABEL_TR_SEARCHTOUR_SEARCHCRITERIATOURMESSAGE = "label.tr.searchtour.SearchCriteriaTourMessage";

    /** label.tr.searchtour.depDateRestrictMessage=Please enter dates in the future after one week from today */
    ...
    /** label.tr.searchtour.searchTourResultMessage=Tour Search Result (sorted by tour days, base price) */
    ...
    /** label.tr.searchtour.titleDetailScreenMessage=Tour Details Screen */
    public static final String LABEL_TR_SEARCHTOUR_TITLEDETAILSCREENMESSAGE = "label.tr.searchtour.titleDetailScreenMessage";

    /** label.tr.searchtour.tourDetailCaptionMessage=Detail Information of the Tour */
    public static final String LABEL_TR_SEARCHTOUR_TOURDETAILCAPTIONMESSAGE = "label.tr.searchtour.tourDetailCaptionMessage";

    /** label.tr.searchtour.loginToReserveMessage=Please press the Login button below in order to make the reservation */
    public static final String LABEL_TR_SEARCHTOUR_LOGINTORESERVEMESSAGE = "label.tr.searchtour.loginToReserveMessage";

    /**
     * label.tr.searchtour.pressReserveBtnMessage=Once the Tour details are confirmed, please press the Reserve button below.
     * <\/br> Please fill in, if there are any suggestions.
     */
    ...
    /** label.tr.searchtour.reserve=Make Reservation */
    ...
    /** label.tr.searchtour.accomName=Name of Accomodation */
    ...
    /** label.tr.searchtour.customerPost=Pincode */
    ...
    /** label.tr.searchtour.searchtourReserveDetailMessage=Tour Reservation Completion Screen */
    ...
    /**
     * label.tr.searchtour.reserveDate=Tour Search&nbsp;\u21D2&nbsp;Tour Details&nbsp;\u21D2&nbsp;Confirmation of Tour
     * Details&nbsp;\u21D2&nbsp;<strong>Finish<\/strong>
     */
    public static final String LABEL_TR_SEARCHTOUR_RESERVEDATE = "label.tr.searchtour.reserveDate";

    /**
     * label.tr.searchtour.reserveNo=Tour Search&nbsp;\u21D2&nbsp;Tour Details&nbsp;\u21D2&nbsp;<strong>Confirmation of Tour
     * Details<\/strong>&nbsp;\u21D2&nbsp;Finish
     */
    public static final String LABEL_TR_SEARCHTOUR_RESERVENO = "label.tr.searchtour.reserveNo";

    /**
     * label.tr.searchtour.goTourSearchScreenMessage=Tour Search&nbsp;\u21D2&nbsp;<strong>Tour
     * Details<\/strong>&nbsp;\u21D2&nbsp;Confirmation of Tour Details&nbsp;\u21D2&nbsp;Finish
     */
    public static final String LABEL_TR_SEARCHTOUR_GOTOURSEARCHSCREENMESSAGE = "label.tr.searchtour.goTourSearchScreenMessage";

    /** label.tr.managereservation.manageReservationMessage=Refer Reservations Screen */
    ...
    /**
     * label.tr.managereservation.manageReservationFlowMessage=<strong>Confirm the List of Reservations <\/strong>\u3000\u21D2
    ...
    /**
     * label.tr.managereservation.manageReservationNoRecordMessage=For refering the details or making changes to a reservation
     * or canceling a reservation, <br \/>
     ...
     * \nPlease call at Phone (01-2345-6789) or visit our office.
     */
    ...
    /**
     * label.tr.managereservation.ReserveListMessage=Reservation List&nbsp;&nbsp; <font>\u203BShown in the ascending order of
     * departure and reservation no<\/font>
     */
    public static final String LABEL_TR_MANAGERESERVATION_RESERVELISTMESSAGE = "label.tr.managereservation.ReserveListMessage";

    /** label.tr.managereservation.reserveNo=Reservation No */
    ...
    /** label.tr.managereservation.changeReservationBtnMessage=Edit the Reservation */
    ...
    /** label.tr.managereservation.cancelReservationBtnMessage=Cancel the Reservation */
    ...
    /** label.tr.managereservation.changeReservationFinBtnMessage=Finalize the Changes */
    ...
    /** label.tr.managereservation.changeReservationStaBtnMessage=Start Over Again */
    ...
    /**
     * label.tr.managereservation.updatedScreenFlowMessage=<font>Edit the contents<\/font> &nbsp;\u21D2&nbsp;<font>Confirm the
     * edited contents<\/font>&nbsp;\u21D2&nbsp;<font><strong>Finish<\/strong><\/font> <br \/>
     */
    ...
    /**
     * label.tr.managereservation.paymentReminderMessage=Please make the payment at the reception or in the bank account before
     * the payment due-date.<br \/>
    ...
    /** label.tr.managereservation.manageReservationShowScreenTitleMessage=Reservation Detail Screen */
    ...
    /**
     * label.tr.managereservation.manageReservationShowScreenFlowMessage=<font>Confirm the list of
     * reservations<\/font>&nbsp;\u21D2&nbsp; <font><strong>Confirm the details of a Reservation<\/strong><\/font>
     */
    ...
    /**
     * label.tr.managereservation.manageReservationShowMessage=Please confirm the detail information of the reservation made by
     * you.<br \/>
     */
    ...
    /** label.tr.managereservation.manageReservationUpdatedScreenTitleMessage=Reservation Change Completion Screen */
    ...
    /** label.tr.managereservation.manageReservationConfirmScreenTitleMessage=Reservation Change Confirmation Screen */
     ...
     * <p>
     * If there is no problem with the changed contents, press the \"Change Reservation\" button below.&nbsp;<\/p>
     */
     ...
     * <p>
     * Please take a note that, there is no change in the payment information below.<\/p>
     */
    ...
    /** label.tr.managereservation.manageReservationEditScreenTitle=Change Reservation Screen */
     ...
     * <p>
     * After making changes to the reservation, press the \"Confirm Reservation\" button below.&nbsp;<\/p>
     */
    ...
    /** label.tr.managereservation.beforecancelScreenTitleMessage=Confirmation Screen for Reservation Cancellation */
    ...
    /**
     * label.tr.managereservation.beforecancelScreenFlowMessage=<strong>Confirm Cancellation
     * Contents<\/strong>&nbsp;\u21D2&nbsp;Finish
     */
    ...
    /** label.tr.managereservation.aftercancelScreenTitleMessage=Reservation Cancellation Screen */
    ...
    /**
     * label.tr.managereservation.aftercancelScreenFlowMessage=Confirm Cancellation
    ...
    /** label.tr.managereservation.confirmEditBtnMessage=Confirm the Change */
