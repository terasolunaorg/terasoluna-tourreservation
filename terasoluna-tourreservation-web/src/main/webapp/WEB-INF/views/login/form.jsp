    ...
    <fieldset>
      ...
      <p>
        <label for="username"><spring:message code="label.tr.common.userId" /></label><br> <input
          type="text" class="text" id="username" name="j_username">
      </p>
      <p>
        <label for="password"><spring:message code="label.tr.common.password" /></label><br> <input
          type="password" class="text" id="password" name="j_password">
      </p>
      <p>
        <input id="loginBtn" type="submit" value="<spring:message code="label.tr.common.login" />">
