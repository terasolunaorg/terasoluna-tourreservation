...
<div class="container">
	...
	<br />
	<spring:message code="label.tr.managereservation.aftercancelScreenMessage" arguments="${f:h(reserveNo)}" />
	<br />
	<div class="span-8">
		...
		<table>
			<tr>
				<td>
					<form:form method="get" action="${f:h(pageContext.request.contextPath)}/reservations/me">
				...
				<td>
					<form:form method="get" action="${f:h(pageContext.request.contextPath)}/" >
