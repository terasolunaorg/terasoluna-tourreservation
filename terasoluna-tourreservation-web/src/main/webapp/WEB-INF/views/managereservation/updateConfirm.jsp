...
<div class="container">
  ...
  <br />
  <!-- begin buttons -->
  <form:form method="post" modelAttribute="manageReservationForm" cssClass="inline"
    ...
    <div class="span-5">
      <table>
        <tr>
          <td><spring:message code="label.tr.managereservation.changeReservationStaBtnMessage"
              var="startOverButton" /> <input id="backToFormBtn" type="submit" name="redo"
            value="${startOverButton}" />
          <td><spring:message code="label.tr.managereservation.changeReservationFinBtnMessage"
