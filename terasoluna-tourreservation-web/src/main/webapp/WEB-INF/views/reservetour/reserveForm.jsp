<div class="container">
  ...
  <sec:authorize ifAllGranted="ROLE_USER">
    ...
    <table>
      ...
      <form:form action="${pageContext.request.contextPath}/reservetour/reserve" method="POST"
        modelAttribute="reserveTourForm">
        <table>
          ...
          <tr>
            ...
            <td><form:textarea path="remarks" tabindex="1" /> <br> <spring:message
      ...
      <form:form action="${pageContext.request.contextPath}/searchtour/search" method="get">
