...
<table id="customerTable">
  ...
  <tr>
    ...
    <td>${f:h(customerForm.customerBirthYear)}<spring:message code="label.tr.common.year" />
      ${f:h(customerForm.customerBirthMonth)}<spring:message code="label.tr.common.month" />
      ${f:h(customerForm.customerBirthDay)}<spring:message code="label.tr.common.day" /></td>
  </tr>
  <tr>
